...
public class GameBackground extends Canvas implements IState {
  ...
  public void drawNPCs() {
    for(NPC npc : PokemonGame.npcList) {
      g2D.drawImage(npc.getImage(), (npc.getXCoord() - dx)/16, (npc.getYCoord() - dy + 8)/16);
    }
  }
  ...
  public void animateImageWithoutBoundary() {
    ...
    // g2D.drawImage(background, 0, 0, cameraViewSize, cameraViewSize, dx -
    // (cameraViewSize / 2.0), dy - (cameraViewSize / 2.0), cameraViewSize,
    // cameraViewSize);
    // }
    // else if(backgroundDX < 0) {
    // System.out.println("Test 2");
    // g2D.drawImage(background, 0, backgroundDY, cameraViewSize, cameraViewSize, dx
    // - (cameraViewSize / 2.0), 0, cameraViewSize, cameraViewSize);
    // }
    // else if(backgroundDY < 0) {
    // System.out.println("Test 2");
    // g2D.drawImage(background, backgroundDX, 0, cameraViewSize, cameraViewSize, 0,
    // dy - (cameraViewSize / 2.0), cameraViewSize, cameraViewSize);
    // }
    // else {
    // g2D.drawImage(background, backgroundDX, backgroundDY, cameraViewSize,
    // cameraViewSize, 0, 0, cameraViewSize, cameraViewSize);
    // }
    g2D.drawImage(background, backgroundSX, backgroundSY, cameraViewSize, cameraViewSize, 0, 0, cameraViewSize,
        cameraViewSize);
