...
public class TextFileReader implements MainMap{
	  protected char[][] characterBoard;
	  protected Point MainMapPlayerPos;
	  protected ArrayList<Door> listOfDoors;

	  protected int col;
	  protected int row;
	  protected Image mainMap;
	  ...
	  protected void createMapGridFromTxtFile(String file) throws FileNotFoundException {
